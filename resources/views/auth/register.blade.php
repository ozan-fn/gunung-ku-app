                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" name="email"
                                ...
                                placeholder="Email">
                            <div {{ $errors->has('email') ? '' : 'hidden' }} class="invalid-feedback">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            ...
                            <div {{ $errors->has('name') ? '' : 'hidden' }} class="invalid-feedback">
                                <i class="bx bx-radio-circle"></i>
                                {{ $errors->first('name') }}
                            </div>
                            <div class="form-control-icon">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="password" name="password_confirmation"
                                class="form-control form-control-xl {{ $errors->has('password_confirmation') ? 'is-invalid' : '' }}"
                                placeholder="Confirm Password">
                            <div {{ $errors->has('password_confirmation') ? '' : 'hidden' }} class="invalid-feedback">
                                <i class="bx bx-radio-circle"></i>
